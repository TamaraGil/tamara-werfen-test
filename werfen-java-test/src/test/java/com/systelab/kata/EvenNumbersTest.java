...
public class EvenNumbersTest {
    ...
    public void testDividerZero() {
        assertTrue(Arrays.equals(new int[]{}, EvenNumbers.divisibleBy(new int[]{0, 1, 2, 3, 4, 5, 6}, 0)));
    }
    
    @Test
    public void testDividerOne() {
        assertTrue(Arrays.equals(new int[]{3, 4, 5, 6}, EvenNumbers.divisibleBy(new int[]{3, 4, 5, 6}, 1)));
    }
}
